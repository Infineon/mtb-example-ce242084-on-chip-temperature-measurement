...
* File Name:   main.c
*
* Description: This is the source code for PPCA Core 0 (CM33) in the
 ...
 * 0x53050400 (M4 window). */
#define PPCA_CPU0_M4_VAR_ADDRESS 0x20040400  /* Shared memory used by PPCA Core 0 */
...
********************************************************************************
* Summary:
* Entry point for PPCA Core 0 (CM33). This core is booted by the main secure
...
int main(void)
{
     /* Infinite loop - add PPCA Core 0 application logic here */
     for(;;)
     {
